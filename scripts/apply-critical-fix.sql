-- Apply just the critical fix for agent registration
-- This creates the idempotent registration function

-- First check if agent_configurations exists, create if not
...
BEGIN
    ...
    -- Handle registration (idempotent by instance_id)
    ...
    -- Also handle the agents table for backward compatibility
