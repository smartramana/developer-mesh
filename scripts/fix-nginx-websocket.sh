...
echo "2. Run E2E tests: cd /path/to/developer-mesh/test/e2e && make test"
echo "3. If issues persist, check application logs: docker logs developer-mesh_mcp-server_1"