// Package embedding provides backward compatibility for code that still imports
// from github.com/S-Corkum/devops-mcp/internal/embedding.
//
// Deprecated: This package is being migrated to github.com/S-Corkum/devops-mcp/pkg/embedding
