...
func TestNewGitHubContentManager(t *testing.T) {
	...
	// Using internal database for tests, which now forwards to pkg/database
	// When internal/database.Database methods are called, they will be forwarded to pkg/database under the hood
