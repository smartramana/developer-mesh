...
CREATE TABLE IF NOT EXISTS mcp.tasks (
    ...
    status mcp.task_status DEFAULT 'pending',
    priority mcp.task_priority DEFAULT 'medium',
...
CREATE TABLE IF NOT EXISTS mcp.task_delegations (
    ...
    delegation_type mcp.delegation_type,
...
CREATE TABLE IF NOT EXISTS mcp.task_state_transitions (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    task_id UUID NOT NULL,
    from_status mcp.task_status,
    to_status mcp.task_status NOT NULL,
...
CREATE TABLE IF NOT EXISTS mcp.workflows (
    ...
    name VARCHAR(255) NOT NULL,
    description TEXT,
    type mcp.workflow_type NOT NULL,
    status mcp.workflow_status DEFAULT 'draft',
...
CREATE TABLE IF NOT EXISTS mcp.workspaces (
    ...
    name VARCHAR(255) NOT NULL,
    description TEXT,
    visibility mcp.workspace_visibility DEFAULT 'private',
    configuration JSONB DEFAULT '{}',
...
CREATE TABLE IF NOT EXISTS mcp.workspace_members (
    ...
    role mcp.member_role DEFAULT 'viewer',
