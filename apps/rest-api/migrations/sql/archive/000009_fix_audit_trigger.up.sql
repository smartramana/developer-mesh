-- Fix audit trigger to set changed_at timestamp
...
-- Drop and recreate the audit trigger function with proper timestamp
...
BEGIN
    ...
    audit_row.changed_at := CURRENT_TIMESTAMP; -- Fix: explicitly set timestamp
